...
public final class profile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if (request.getSession().getAttribute("conf") != null){
      ...
      out.write("<title>Strona profilowa</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<h1>Witaj, ");
 ...
 if(user.getAccessLevel() > UserModel.ADMIN) {
      ...
      out.write("\tChcesz dodać użytkownika premium? Podaj jego login\r\n");
      out.write("\t\t<label>Login:<input type=\"text\" id=\"name\" name=\"name\"/></label><br/>\r\n");
      out.write("\t</form>\r\n");
      out.write("\t");
 } 
      out.write("\r\n");
